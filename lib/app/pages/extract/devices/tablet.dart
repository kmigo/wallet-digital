...
class ExtractTablet extends StatefulWidget {
  const ExtractTablet({super.key});

  @override
  State<ExtractTablet> createState() => _ExtractTabletState();
}

class _ExtractTabletState extends State<ExtractTablet> {
